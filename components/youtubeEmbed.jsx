...
const YoutubeEmbed = function ({ embedId }) {
  ...
  return (
    ...
    <div className="video-responsive">
      ...
      <div className="mb-10 ">
        <h2 className="pb-5 text-4xl font-semibold leading-6 tracking-wider text-white uppercase sm:text-3xl lg:text-4xl">South Down Barbell Club</h2>
        <p className="mt-2 text-3xl font-extrabold text-red-700 sm:text-4xl lg:text-5xl">
          Strength & Conditioning Personal Training
        </p>
      </div>
      <div className="items-center"><iframe
